...
void Humidity::drawOuterCircle(QPainter *painter)
{
    painter->save();
...
void Humidity::drawInnerCircle(QPainter *painter)
{
    painter->save();
...
void Humidity::drawMark(QPainter *painter)
{
    painter->save();
...
void Humidity::drawCoverBall(QPainter *painter)
{
    painter->save();
...
void Humidity::drawTextRect(QPainter *painter)
{
    painter->save();
...
void Humidity::drawCoverCircle(QPainter *painter)
{
    painter->save();
...
void Humidity::drawColorPie(QPainter *painter)
{
    painter->save();
...
void Humidity::resetVariables(QPainter *painter)
{
    m_outerRadius=width()>height() ? height()/2: width()/2;
    m_innerRadius=m_outerRadius/8*7;
    m_coverCircleRadius=m_outerRadius/8*4+10;
...
void Humidity::setValue(qreal value)
{
    if(value>m_value)
    {
        m_bReverse=false;
