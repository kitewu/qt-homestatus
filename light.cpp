...
void Light::drawOuterCircle(QPainter *painter)
{
    painter->save();
...
void Light::drawInnerCircle(QPainter *painter)
{
    painter->save();
...
void Light::drawMark(QPainter *painter)
{
    painter->save();
...
void Light::drawCoverBall(QPainter *painter)
{
    painter->save();
...
void Light::drawTextRect(QPainter *painter)
{
    painter->save();
    ...
    QString strValue;
    strValue=tr("%1").arg(m_value*10);
    painter->drawText(textRect,Qt::AlignHCenter|Qt::AlignVCenter,strValue);
    painter->restore();
}

void Light::drawCoverCircle(QPainter *painter)
{
    painter->save();
...
void Light::drawColorPie(QPainter *painter)
{
    painter->save();
...
void Light::drawIndicator(QPainter *painter)
{
    painter->save();
...
void Light::resetVariables(QPainter *painter)
{
    m_outerRadius=width()>height() ? height()/2: width()/2;
    m_innerRadius=m_outerRadius/8*7;
    m_coverCircleRadius=m_outerRadius/8*4+10;
...
void Light::setValue(qreal value)
{
    value /= 10;
